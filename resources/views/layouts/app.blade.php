        ...
        <footer class="bg-[#020617] border-t border-slate-800/60 pt-16 pb-8 relative overflow-hidden">
            <div class="max-w-7xl mx-auto px-8 relative z-10">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="/#services" class="text-slate-400 hover:text-indigo-400 text-sm transition-colors flex items-center gap-2 group"><span class="w-1.5 h-px bg-slate-700 group-hover:w-3 group-hover:bg-indigo-500 transition-all"></span> Jastip Makanan</a></li>
                        <li><a href="/#services" class="text-slate-400 hover:text-indigo-400 text-sm transition-colors flex items-center gap-2 group"><span class="w-1.5 h-px bg-slate-700 group-hover:w-3 group-hover:bg-indigo-500 transition-all"></span> Print Tugas</a></li>
                        <li><a href="/#services" class="text-slate-400 hover:text-indigo-400 text-sm transition-colors flex items-center gap-2 group"><span class="w-1.5 h-px bg-slate-700 group-hover:w-3 group-hover:bg-indigo-500 transition-all"></span> Angkut Barang</a></li>
                    </ul>
                </div>

                {{-- Contact --}}
                <div>
                    <h4 class="text-white font-bold text-sm mb-6 uppercase tracking-widest">Hubungi Kami</h4>
                    <ul class="space-y-4">
                        <li><a href="https://wa.me/6285730740392" target="_blank" class="text-slate-400 hover:text-emerald-400 text-sm transition-colors flex items-center gap-3">
                        ...
                        <li><a href="mailto:support@pasrah.in" class="text-slate-400 hover:text-indigo-400 text-sm transition-colors flex items-center gap-3">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            Email Support
                        </a></li>
                        <li><a href="https://instagram.com/pasrah.in_" target="_blank" class="text-slate-400 hover:text-pink-400 text-sm transition-colors flex items-center gap-3">
            ...
            <div class="pt-8 border-t border-slate-800/60 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="flex items-center gap-4">
                    <span class="text-[10px] text-slate-600 font-bold uppercase tracking-widest">Metode Pembayaran Aman:</span>
                    <div class="flex items-center gap-3 opacity-40 grayscale hover:grayscale-0 hover:opacity-100 transition-all">
                        <span class="text-[10px] font-black text-white">MIDTRANS</span>
                        <span class="text-[10px] font-black text-white">QRIS</span>
                        <span class="text-[10px] font-black text-white">GOPAY</span>
                    </div>
                </div>
            </div>
        </div>
